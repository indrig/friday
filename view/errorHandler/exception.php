<?php
/* @var $this \Friday\Web\View */
/* @var $exception \Exception */
/* @var $handler \Friday\Web\ErrorHandler */
?>
...
<head>
    ...
    <title><?php
        ...
        if ($exception instanceof \Friday\Web\HttpException\HttpException) {
...
<body>
    <div class="header">
        <?php if ($exception instanceof \Friday\Base\Exception\ErrorException): ?>
        ...
        <?php if ($exception instanceof \Friday\Db\Exception\Exception && !empty($exception->errorInfo)) {
    ...
    <div class="footer">
        ...
        <p>Friday Framework/<?= $handler->createFrameworkVersionLink() ?></p>
    </div>
