...
class StringHelper
{
    ...
    {
        if ($asHtml) {
            return static::truncateHtml($string, $length, $suffix, $encoding ?: Friday::$app->charset);
        }

        if (mb_strlen($string, $encoding ?: Friday::$app->charset) > $length) {
            return trim(mb_substr($string, 0, $length, $encoding ?: Friday::$app->charset)) . $suffix;
        } else {
            return $string;
        }
    }
    ...
    protected static function truncateHtml($string, $count, $suffix, $encoding = false)
    {
        ...
        $config->set('Cache.SerializerPath', \Friday::$app->getRuntimePath());
    ...
    public static function startsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, 0, $bytes, '8bit'), Friday::$app->charset) === mb_strtolower($with, Friday::$app->charset);
        }
    }
    ...
    public static function endsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, -$bytes, mb_strlen($string, '8bit'), '8bit'), Friday::$app->charset) === mb_strtolower($with, Friday::$app->charset);
        }
    }
