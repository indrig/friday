...
class Html
{
    ...
    {
        return htmlspecialchars($content, ENT_QUOTES | ENT_SUBSTITUTE, Friday::$app ? Friday::$app->charset : 'UTF-8', $doubleEncode);
    }
    ...
    {
        $header = isset($options['header']) ? $options['header'] : '<p>' . Friday::t('Please fix the following errors:') . '</p>';
