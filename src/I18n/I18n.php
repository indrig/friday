...
class I18n extends Component
{
    ...
    public function init()
    {
        ...
        if (!isset($this->translations['app']) && !isset($this->translations['friday*'])) {
            $this->translations['app'] = [
                'class' => 'Friday\I18n\PhpMessageSource',
                'sourceLanguage' => Friday::$app->sourceLanguage,
    ...
    public function format($message, $params, $language)
    {
        ...
        if (preg_match('~{\s*[\d\w]+\s*,~u', $message)) {
            ...
            if ($result === false) {
                ...
                Friday::warning("Formatting message for language '$language' failed with error: $errorMessage. The message being formatted was: $message.", __METHOD__);
    ...
    public function getMessageFormatter()
    {
        if ($this->_messageFormatter === null) {
            ...
            $this->_messageFormatter = Friday::createObject($this->_messageFormatter);
        }
