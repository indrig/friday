...
class MessageFormatter extends Component
{
     ...
     * @throws NotSupportedException when PHP intl extension is not installed.
     */
    ...
    {
        $charset = Friday::$app ? Friday::$app->charset : 'UTF-8';
        $depth = 1;
     ...
     * @throws NotSupportedException when unsupported formatting is used.
     */
