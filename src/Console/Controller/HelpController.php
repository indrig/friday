...
class HelpController extends Controller
{
    ...
    {
        if ($command !== null) {
            $result = Friday::$app->createController($command);
            if ($result === false) {
    ...
    {
        $commands = $this->getModuleCommands(Friday::$app);
        sort($commands);
     ...
     * @param \Friday\Base\Module $module the module instance
     * @return array the available command names
     */
    protected function getModuleCommands($module)
    {
        $prefix = $module instanceof AbstractApplication ? '' : $module->getUniqueId() . '/';
    ...
    protected function validateControllerClass($controllerClass)
    {
        if (class_exists($controllerClass)) {
            ...
            return !$class->isAbstract() && $class->isSubclassOf('Friday\Console\Controller');
        } else {
            return false;
        }
    }
    ...
    protected function getDefaultHelp()
    {
        ...
        $this->stdout("\nThis is Friday version " . Friday::getVersion() . ".\n");
        if (!empty($commands)) {
    ...
    protected function getSubCommandHelp($controller, $actionID)
    {
        ...
        $options[\Friday\Console\Application::OPTION_APPCONFIG] = [
            'type' => 'string',
            'default' => null,
    ...
    {
        return basename(Friday::$app->request->scriptFile);
    }
}
