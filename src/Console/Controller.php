...
class Controller extends BaseController{
        ...
        if (!empty($params)) {
            ...
            if (isset($params['_aliases'])) {
                ...
                foreach ($params['_aliases'] as $name => $value) {
                    if (array_key_exists($name, $optionAliases)) {
                        ...
                        throw new Exception(Friday::t('friday', 'Unknown alias: -{name}', ['name' => $name]));
                    }
                }
            ...
            foreach ($params as $name => $value) {
                if (in_array($name, $options, true)) {
                    ...
                    throw new Exception(Friday::t('friday', 'Unknown option: --{name}', ['name' => $name]));
                }
            }
        }
    ...
    public function bindActionParams($action, $params)
    {
        ...
        if (!empty($missing)) {
            throw new Exception(Friday::t('friday', 'Missing required arguments: {params}', ['params' => implode(', ', $missing)]));
        }
     ...
     *
     * You may pass additional parameters using the constants defined in [[\Friday\Helper\Console]].
     *
     * Example:
     *
     * ```
     ...
     * passing additional parameters using the constants defined in [[\Friday\Helper\Console]].
     *
     * Example:
     *
     * ```
