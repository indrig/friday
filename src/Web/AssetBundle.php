...
class AssetBundle extends BaseObject
{
    ...
    public function init()
    {
        if ($this->sourcePath !== null) {
            $this->sourcePath = rtrim(AliasHelper::getAlias($this->sourcePath), '/\\');
        }
        if ($this->basePath !== null) {
            $this->basePath = rtrim(AliasHelper::getAlias($this->basePath), '/\\');
        }
     ...
     * @param \Friday\Web\View $view the view that the asset files are to be registered with.
     */
