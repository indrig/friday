...
class Controller extends BaseController{
    ...
    public function beforeAction($action)
    {
        if (parent::beforeAction($action)) {
            if ($this->enableCsrfValidation && Friday::$app->getErrorHandler()->exception === null && !$this->connectionContext->request->validateCsrfToken()) {
                throw new BadRequestHttpException(Friday::t('Unable to verify your data submission.'));
            }
            return true;
        }
    ...
    {
        return $this->connectionContext->response->redirect($this->connectionContext->request->getUrl() . $anchor);
    }
}