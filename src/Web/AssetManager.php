...
class AssetManager extends Component
{
    ...
    {
        parent::init();
        $this->basePath = AliasHelper::getAlias($this->basePath);
        ...
        $this->baseUrl = rtrim(AliasHelper::getAlias($this->baseUrl), '/');
    }
    ...
    protected function resolveAsset($bundle, $asset)
    {
        ...
        $n = mb_strlen($asset, Friday::$app->charset);
        foreach ($this->assetMap as $from => $to) {
            $n2 = mb_strlen($from, Friday::$app->charset);
