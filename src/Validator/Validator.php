 ...
 * - `captcha`: [[\Friday\Captcha\CaptchaValidator]]
...
class Validator extends Component
{
    ...
    public static $builtInValidators = [
        'boolean' => 'Friday\Validator\BooleanValidator',
        'captcha' => 'Friday\captcha\CaptchaValidator',
        'compare' => 'Friday\Validator\CompareValidator',
        'date' => 'Friday\Validator\DateValidator',
        'default' => 'Friday\Validator\DefaultValueValidator',
        'double' => 'Friday\Validator\NumberValidator',
        'each' => 'Friday\Validator\EachValidator',
        'email' => 'Friday\Validator\EmailValidator',
        'exist' => 'Friday\Validator\ExistValidator',
        'file' => 'Friday\Validator\FileValidator',
        'filter' => 'Friday\Validator\FilterValidator',
        'image' => 'Friday\Validator\ImageValidator',
        'in' => 'Friday\Validator\RangeValidator',
        'integer' => [
            'class' => 'Friday\Validator\NumberValidator',
            'integerOnly' => true,
        ],
        'match' => 'Friday\Validator\RegularExpressionValidator',
        'number' => 'Friday\Validator\NumberValidator',
        'required' => 'Friday\Validator\RequiredValidator',
        'safe' => 'Friday\Validator\SafeValidator',
        'string' => 'Friday\Validator\StringValidator',
        'trim' => [
            'class' => 'Friday\Validator\FilterValidator',
            'filter' => 'trim',
            'skipOnArray' => true,
        ],
        'unique' => 'Friday\Validator\UniqueValidator',
        'url' => 'Friday\Validator\UrlValidator',
        'ip' => 'Friday\Validator\IpValidator',
    ];
    /**
    ...
    public static function createValidator($type, $model, $attributes, $params = [])
    {
        ...
        return Friday::createObject($params);
    }
     ...
     * @param \Friday\Base\Model $model the data model being validated
    ...
    public function validateAttributes($model, $attributes = null) : Awaitable
    {
        ...
        return AwaitableHelper::all($validators);
    }
     ...
     * @param \Friday\Base\Model $model the data model being validated
     * @param string $attribute the name of the attribute to be validated.
     * @param \Friday\Web\View $view the view object that is going to be used to render views or view files
     * containing a model form with this validator applied.
     * @return string the client-side validation script. Null if the validator does not support
     * client-side validation.
     * @see \Friday\Widget\ActiveForm::enableClientValidation
     */
    ...
    public function addError($model, $attribute, $message, $params = [])
    {
        ...
        $params['value'] = is_array($value) ? 'array()' : $value;
        $model->addError($attribute, Friday::$app->getI18n()->format($message, $params, Friday::$app->language));
    }
