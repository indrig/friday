...
abstract class BaseActiveRecord extends Model implements ActiveRecordInterface
{
     ...
     * @throws BadMethodCallException if the method is unable to link two models.
     */
    public function link($name, $model, $extraColumns = [])
    {
        ...
        if ($relation->via !== null) {
            if ($this->getIsNewRecord() || $model->getIsNewRecord()) {
                throw new BadMethodCallException('Unable to link models: the models being linked cannot be newly created.');
            }
            ...
            if ($p1 && $p2) {
                if ($this->getIsNewRecord() && $model->getIsNewRecord()) {
                    throw new BadMethodCallException('Unable to link models: at most one model can be newly created.');
                ...
                throw new BadMethodCallException('Unable to link models: the link defining the relation does not involve any primary key.');
            }
        }
     ...
     * @throws BadMethodCallException if the models cannot be unlinked
     */
    public function unlink($name, $model, $delete = false)
    {
        ...
        if ($relation->via !== null) {
            ...
            if ($p2) {
                ...
                throw new BadMethodCallException('Unable to unlink models: the link does not involve any primary key.');
            }
        }
    ...
    private function bindModels($link, $foreignModel, $primaryModel)
    {
        foreach ($link as $fk => $pk) {
            ...
            if ($value === null) {
                throw new BadMethodCallException('Unable to link models: the primary key of ' . get_class($primaryModel) . ' is null.');
            }
