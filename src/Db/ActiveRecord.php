...
class ActiveRecord extends BaseActiveRecord
{
     ...
     * @return  Awaitable $this the model instance itself.
     */
    public function loadDefaultValues($skipIfSet = true) : Awaitable
    {
     ...
     * @return Adapter the database connection used by this AR class.
     */
    public static function getDb()
    {
        return Friday::$app->getDb();
    }
     ...
     * @return Awaitable integer the number of rows updated
     */
     ...
     * @return Awaitable integer the number of rows updated
     */
    public static function updateAllCounters($counters, $condition = '', $params = []) : Awaitable
    {
        $n = 0;
     ...
     * Please refer to [[Query::where()]] on how to specify this parameter.
     * @param array $params the parameters (name => value) to be bound to the query.
     * @return Awaitable integer the number of rows deleted
     */
    public static function deleteAll($condition = '', $params = []) : Awaitable
    {
        $command = static::getDb()->createCommand();
    ...
    {
        return Friday::createObject(ActiveQuery::className(), [get_called_class()]);
    }
     ...
     * @return Awaitable TableSchema the schema information of the DB table associated with this AR class.
     * @throws InvalidConfigException if the table for the AR class does not exist.
     */
    public static function getTableSchema() : Awaitable
    {
        $deferred = new Deferred();
        static::getDb()
            ->getSchema()
    ...
    public static function populateRecord($record, $row)
    {
        ...
        static::getTableSchema()->await(function ($tableSchema) use ($deferred, &$record, &$row){
            if($tableSchema instanceof Throwable){
                $deferred->exception($tableSchema);
            } else {
