...
class DataReader extends BaseObject implements Iterator, Countable
{
    ...
    {
        $this->_statement = $command->statement;
        $this->_statement->setFetchMode(StatementInterface::FETCH_ASSOC);
   ...
   /* public function nextResult()
     ...
     * @throws BadMethodCallException if this method is invoked twice
     */
    public function rewind()
    {
        if ($this->_index < 0) {
            ...
            throw new BadMethodCallException('DataReader cannot rewind. It is a forward-only reader.');
        }
    }
