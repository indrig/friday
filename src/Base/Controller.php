...
class Controller extends Component implements ViewContextInterface
{
    ...
    public function runAction($id, $params = [])
    {
        ...
        Friday::trace('Route to run: ' . $action->getUniqueId(), __METHOD__);
     ...
     * @return View|\Friday\Web\View the view object that can be used to render views or view files.
     */
     ...
     * @param View|\Friday\Web\View $view the view object that can be used to render views or view files.
     */
    ...
    public function findLayoutFile($view)
    {
        ...
        if (strncmp($layout, '@', 1) === 0) {
            $file = AliasHelper::getAlias($layout);
        } elseif (strncmp($layout, '/', 1) === 0) {
            $file = Friday::$app->getLayoutPath() . DIRECTORY_SEPARATOR . substr($layout, 1);
        } else {
        ...
        if ($view->defaultExtension !== 'phtml' && !is_file($path)) {
            $path = $file . '.phtml';
        }
