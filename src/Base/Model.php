...
use Friday\Validator\RequiredValidator;
use Friday\Validator\Validator;
 ...
 *
 * @property \Friday\Validator\Validator[] $activeValidators The validators applicable to the current
 ...
 * @property ArrayObject|\Friday\Validator\Validator[] $validators All the validators declared in the model.
 * This property is read-only.
 */
class Model extends Component implements IteratorAggregate, ArrayAccess, ArrayableInterface
{
    use ArrayableTrait;
